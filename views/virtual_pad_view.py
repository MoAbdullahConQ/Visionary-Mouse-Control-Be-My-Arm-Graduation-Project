...
class VirtualPadView(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        pixmap2 = QtGui.QPixmap("images/virtual_pad.png")
        if pixmap2.isNull():
            print("Image 2 failed to load! Check the path.")
        else:
            self.image_label2.setPixmap(pixmap2.scaled(550, 550, QtCore.Qt.AspectRatioMode.KeepAspectRatio,
                                                       QtCore.Qt.TransformationMode.SmoothTransformation))
            self.image_label2.move(280, 150)  # Adjust position for overlay

        # Add title label
        self.title_label = QtWidgets.QLabel("Choose Pad", self)
        ...
        self.vertical_line.move(1070, 200)  # Positioning it beside the title (adjust as necessary)



        # Add subtitle label with manual line breaks
        self.subtitle_label = QtWidgets.QLabel(
            "Choose your magic: the Basic Pad for\n\n effortless control or the AI Pad for smart,\n\n adaptive guidance. Your journey awaits!", self)
        ...
        # Create the button
        self.button = QPushButton("  Basic Pad", self)
        ...
        self.button.clicked.connect(lambda: self.parent.navigate_to_basic_pad())  # Navigate to FaceModelPage
        ...
        # Create the button
        self.button2 = QPushButton("  AI Pad", self)
        ...
        self.button2.clicked.connect(lambda: self.parent.navigate_to_AI_pad())  # Navigate to FaceModelPage
    ...
    def set_button_with_image(self, button):
        ...
        pixmap = QPixmap \
            ("images/trackpad.png")  # Ensure to use the correct image path
    ...
    def set_button_with_image2(self, button2):
        ...
        # Load the image as a QPixmap
        pixmap = QPixmap \
            ("images/pencil.png")  # Ensure to use the correct image path
